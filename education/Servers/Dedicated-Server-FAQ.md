...
hash:
  ...
  h_01KJZEH35ZGHXPQ5PS494TRTH0: 5are-dedicated-servers-enabled-by-default
...
You'll just to be sure your host device meets our [Dedicated Server System Requirements](./Dedicated-Server-System-Requirements.md). 
...
Please refer to the [Dedicated Server Installation Guide](./IT-Admin-Create-Dedicated-Servers.md) for more advanced techniques.
