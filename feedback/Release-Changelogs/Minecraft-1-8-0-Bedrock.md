...
- **Add-Ons:**
  ...
  - Added a underscore to "frozen_river" in the 'biomes_client.json' file so it matches the other vanilla Resource Pack entries ([MCPE-36799](https://bugs.mojang.com/browse/MCPE-36799))
