  h_01KZ41YACVH6BGD9CR49STZH1H: features
  h_01KZ41YACV5WV2H0YQ7SRM9V01: general-1
  h_01KZ41YACW9XMCMMZ975744Y93: graphical-2
  h_01KZ41YACXBS15Q6941X3F2TBE: items-1
  h_01KZ41YACZF5DE2WMG4APFG4E2: item-components
  h_01KZ41YACZS8A8GB4839ZPH0AE: json-schema
  h_01KZ41YACZMZW9SWBGQTM2PG7E: networking
  h_01KZ41YAD0BK4BBYM54YRTG7FK: particles
  h_01KZ41YAD059TQV8QTZVTXBW1K: sounds-2
  h_01KZ41YAD0EV9E7NENPHC84V7M: user-interface-1
  h_01KZ41YAD0Q9RGC59EAX9WK3Z9: experimental-technical-updates
  h_01KZ41YAD0H08FG5S9MERFSFGS: add-ons
  h_01KZ41YAD0QPFEBPGR5D5KDMQN: api-1
  h_01KZ41YADKE7DPF3SN3GYNKK35: dimension-1
  h_01KZ41YADK260X3NCQRW5D6V3F: sounddurationinfo
  h_01KZ41YADMHP9YQZQB63ENWKAP: blocks-3
  h_01KZ41YADQKNCVC2QNBZ88Z24F: voxel-shapes
  h_01KZ41YADQSKANR9QXDXGDV4YR: ddui-1
  h_01KZ41YADQS16DA7CNV8FMV6SF: editor-1
  h_01KZ41YADQBEHQWW7GWQ2ZNV9H: items-2
  h_01KZ41YADQE0J4F3EH08PN592J: jigsaw-structures
  h_01KZ41YADRM4R61RJ0ZMB33592: sounds-3
  h_01KZ41YADVY8MHR9FR63TN05M8: user-interface-2
---

**Posted:** 4 August 2026

<figure class="wysiwyg-image">
<img src="https://feedback.minecraft.net/hc/article_attachments/47787728136845" alt="A Minecraft village at sunrise. There is a boat with a chest on some water in the foreground." />
</figure>
...
- Arrows shot downwards get stuck in the player's own hitbox ([MCPE-240527](https://bugs.mojang.com/browse/MCPE-240527))
...
- Added opaque versions to the Poplar leaves to fix black background issue ([MCPE-240020](https://bugs.mojang.com/browse/MCPE-240020 "https://bugs.mojang.com/browse/mcpe-240020"))
...
- The screen no longer jitters when the Screen Distortion accessibility setting is changed ([MCPE-239556](https://bugs.mojang.com/browse/MCPE-239556))
...
- Sulfur and Cinnabar Stairs no longer prevent Chests from opening ([MCPE-239689](https://bugs.mojang.com/browse/MCPE-239689))
- Fixed issue where air would not be replenished by air bubbles ([MCPE-239551](https://bugs.mojang.com/browse/MCPE-239551))
- Azalea and Flowering Azalea are no longer see-through when viewed from below ([MCPE-217896](https://bugs.mojang.com/browse/MCPE-217896))
- Brown and Red Mushrooms can no longer be placed under the sky when it is dark
- With the Minecraft Education features toggle enabled, it is possible to place charcoal again in the Lab Table ([MCPE-240097](https://bugs.mojang.com/browse/MCPE-240097))
...
- Fixed an ID collision when adding split-screen guests on Nintendo Switch, allowing multiple guests to join reliably
- Fixed an issue where structure loot would differ on the same seed ([MCPE-239951](https://bugs.mojang.com/browse/MCPE-239951))
...
- Fixed an issue where colored light-emitting blocks no longer emitted light in worlds using the official RTX texture pack. ([MCPE-218532](https://bugs.mojang.com/browse/MCPE-218532))
- Atlas composited textures for blocks now render correctly ([MCPE-223126](https://bugs.mojang.com/browse/MCPE-223126))
...
- Arrow damage now scales with velocity instead of being fully randomized ([MCPE-161077](https://bugs.mojang.com/browse/MCPE-161077))
...
- The screen no longer flickers when drinking a Milk Bucket while the Nausea effect is active ([MCPE-239698](https://bugs.mojang.com/browse/MCPE-239698))
- Fixed issue where book and quill from pre-26.30 worlds freezes the game ([MCPE-239753](https://bugs.mojang.com/browse/MCPE-239753))
...
- The item label for a Bucket of a named Sulfur Cube now includes its absorbed Block ([MCPE-238162](https://bugs.mojang.com/browse/MCPE-238162))
...
- Blocks absorbed by a Sulfur Cube are now rendered with the same facing direction as in Java Edition ([MCPE-238269](https://bugs.mojang.com/browse/MCPE-238269))
...
- Sulfur Cubes carrying an absorbed block now emit landing particles when they hit the ground ([MCPE-239318](https://bugs.mojang.com/browse/MCPE-239318))
...
- Fixed issue where sheep do not eat grass after being sheared ([MCPE-239548](https://bugs.mojang.com/browse/MCPE-239548))
...
- Saves: Manage and restore your automatic and manually saved Realm worlds directly from the Realm Hub.
- Realms Hub is now accessible from the In-game pause menu
- Fixed an error that occurred when opening Realms Hub without Admin permissions
- Prevent Realm owners from modifying admin's gameplay permissions
...
- Fixed a crash that could occur when backing out of an NPC's Advanced Settings ([MCPE-239589](https://bugs.mojang.com/browse/MCPE-239589))
...
- Don't hide the tooltips option when any behavior pack is downloaded ([MCPE-184669](https://bugs.mojang.com/browse/MCPE-184669))
- Improved performance when scrolling the Crafting Recipe Book ([MCPE-231750](https://bugs.mojang.com/browse/MCPE-231750)) ([MCPE-235811](https://bugs.mojang.com/browse/MCPE-235811))
...
- Fixed a bug where text formatting codes in a resource pack's name carried over into the rest of the toast notification when the pack was activated or deactivated ([MCPE-182130](https://bugs.mojang.com/browse/MCPE-182130))
...
- The Pause Game setting is now rendered in the Main Menu ([MCPE-237101](https://bugs.mojang.com/browse/MCPE-237101))
- Show "Game unpaused" notification over all screens when the pause screen is open ([MCPE-229796](https://bugs.mojang.com/browse/MCPE-229796))
...
- Fixed Cloud sync storage banner to not show redundant information that storage is both full and almost full when cloud storage is full ([MCPE-240036](https://bugs.mojang.com/browse/MCPE-240036))
- Fixed the Beacon screen displaying a duplicated header in the Pocket UI
- Create New World list is loaded correctly after deleting world data through the "Manage Worlds" button ([MCPE-239804](https://bugs.mojang.com/browse/MCPE-239804))
- Updated Nintendo Switch terminology for local wireless multiplayer
- Fixed a problem that caused touch scrolling to be unresponsive in creative inventory. ([MCPE-236783](https://bugs.mojang.com/browse/MCPE-236783))
- Fixed an issue that prevented splitscreen players from interacting with Game Settings. ([MCPE-237830](https://bugs.mojang.com/browse/MCPE-237830))
...
- Removed space appearing between the chat tab and the social drawer ([MCPE-239456](https://bugs.mojang.com/browse/MCPE-239456))
...
- Align brightness sampling strategies between custom and vanilla blocks ([MCPE-237493](https://bugs.mojang.com/browse/MCPE-237493))
...
- Sulfur Spring minecraft:structure_template_feature definitions now reference their structure templates with the minecraft: namespace ([MCPE-237893](https://bugs.mojang.com/browse/MCPE-237893))
...
- Fixed the destroy block sound position to be at the center of the block instead of at the corner ([MCPE-60799](https://bugs.mojang.com/browse/MCPE-60799))
