...
``` {.has-line-data line-start="92" line-end="97"}
...
``` {.has-line-data line-start="196" line-end="209"}
"filter": {
    "block": [
        {
            "namespace": "minecraft",
...
``` {.has-line-data line-start="235" line-end="237"}
...
``` {.has-line-data line-start="239" line-end="244"}
 "type_specific": {
    "type": "cat",
...
``` {.has-line-data line-start="248" line-end="252"}
 "lightning_bolt": {
...
``` {.has-line-data line-start="254" line-end="259"}
  "type_specific": {
    "type": "lightning",
    "blocks_set_on_fire": 0
  }
