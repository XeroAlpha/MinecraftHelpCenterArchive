...
hash:
  ...
  h_01KY2H59M1C6V13099P2VF6MP6: drop-3-experimental-features
  h_01KY2H59M1R59XN4BE67TDPKXY: abandoned-camp
  h_01KY2H59M4KJ0MV900CKCXGJ98: accessibility
  h_01KY2H59M4NT7EZ7BE5730M9AN: blocks
  h_01KY2H59MA81TQ1Y999RVQAR7J: cushion
  h_01KY2H59MEMDVE9ETQYA1WXT0R: graphical
  h_01KY2H59MGCGSAP4B6B7BHZZ0V: mobs
  h_01KY2H59MHYA4VQD26AR1GKZMW: features-and-bug-fixes
  h_01KY2H59MJC17GFQKE2ZQX4BCM: accessibility-features
  h_01KY2H59MKVE9MDFWMT240DFBP: gameplay
  h_01KY2H59MM926QZTH76Q9QR0W3: graphical-1
  h_01KY2H59MPRXEP7H24QBX1FR4Y: items
  h_01KY2H59MPWYCSD771FZKTPR0A: mobs-1
  h_01KY2H59MQ02A731QX2P6RYJ2W: pack-settings
  h_01KY2H59MQH24XFTK9H966WS6V: realms
  h_01KY2H59MTEQGD8B94R9WE5HVY: stability-and-performance
  h_01KY2H59MVBJAKRXSMZKP0GYGF: user-interface
  h_01KY2H59MZ53198A4SZEVFNAWD: marketplace
  h_01KY2H59N046G879GZJ11KAJQ1: play-screen
  h_01KY2H59N0FKBQGKWE65NZ5JDD: settings
  h_01KY2H59N0S72R7AD8TMP4FAR0: storage
  h_01KY2H59N1K2C0R8EH31JE2MZ9: technical-updates
  h_01KY2H59N1RJMKWHW0QGA51XR4: actor-components
  h_01KY2H59N1ZX9E7BRQS7NYQNQV: ai-components
  h_01KY2H59N6ZT11BM25D0RESD18: api
  h_01KY2H59NJZ7QX3KQ7K9WAAC4T: ddui
  h_01KY2H59NJKF73E0M22HE79AF2: server-ui
  h_01KY2H59NJ44VN4VR204WFJAK1: editor
  h_01KY2H59NPG2PJTK4VMP0PMGKV: entity-components
  h_01KY2H59NREM7Y0FSNF0VH75SD: features
  h_01KY2H59NWENNZMKNDJ7Z4WACM: example
  h_01KY2H59NXCGR40NRDR55X921Z: graphics
  h_01KY2H59P07F7MNS27GM2WPCH2: molang
  h_01KY2H59P02A0VD6XBMF75GC0K: packs
  h_01KY2H59P1PPHWPNR7VPPGB5RD: stability-and-performance-1
  h_01KY2H59P1M1VFPSVRM6AJ4Y5C: experimental-technical-updates
  h_01KY2H59P1YCASRN4QF14QPN30: api-1
  h_01KY2H59P2Q3Y1YFR0N8PNT4DK: ddui-1
  h_01KY2H59P8N5582H8PV2MDEZJV: sounddurationinfo
  h_01KY2H59P8FVJQT0JGN92489GN: blocks-1
  h_01KY2H59P80B3K7P0R4MKC3EP4: gameplay-1
---
...
<img src="https://feedback.minecraft.net/hc/article_attachments/47534782337805" alt="dappled_preview_1.jpg" />
</figure>
...
- Added localized closed captions for jumping and landing on Poplar Leaves ([MCPE-240465](https://bugs.mojang.com/browse/MCPE-240465))

### Blocks

- Poplar Saplings can now be composted ([MCPE-240015](https://bugs.mojang.com/browse/MCPE-240015))
- Shelf Mushrooms now burn correctly when exposed to lava
- Wool Stairs and Wool Slabs no longer conduct Redstone signals ([MCPE-240018](https://bugs.mojang.com/browse/MCPE-240018))
- Fixed the stretched mining/cracking overlay when mining a Straw Bed ([MCPE-240484](https://bugs.mojang.com/browse/MCPE-240484))
...
- Cushion name is now correctly translated ([MCPE-240461](https://bugs.mojang.com/browse/MCPE-240461))
- Nudged the Cushion placement downwards slightly ([MCPE-240468](https://bugs.mojang.com/browse/MCPE-240468))
- Increased the sitting height on the Cushion by one texel ([MCPE-240499](https://bugs.mojang.com/browse/MCPE-240499))

### Graphical

- Fixed poplar sign UI texture to be in parity with Java
- Fixed Hay Bale to be symmetrical ([MCPE-240723](https://bugs.mojang.com/browse/MCPE/issues/MCPE-240723))
...
- A green vignette now appears while the nausea effect is active when screen distortion is turned all the way off via accessibility settings ([MCPE-239554](https://bugs.mojang.com/browse/MCPE-239554))

### Gameplay

- Fixed Hoppers unintentionally collecting items on its side at large coordinates ([MCPE-99462](https://bugs.mojang.com/browse/MCPE-99462))
- Fixed Droppers facing east or south inserting items into containers below them instead of ejecting items forward ([MCPE-167490](https://bugs.mojang.com/browse/MCPE-167490))

### Graphical

- Fixed missing Baby Fox texture ([MCPE-240546](https://bugs.mojang.com/browse/MCPE-240546))
- Fixed clouds rendering as bright white spots after switching to Vibrant Visuals in-game with low cloud render distance

### Items

- Updated Sulfur Cube Spawn Egg icon's MERS ([MCPE-237771](https://bugs.mojang.com/browse/MCPE-237771))
...
- Fixed an issue where players would sometimes not respawn at their bed or respawn anchor after dying in a different dimension on a Realm ([REALMS-14459](https://bugs.mojang.com/browse/REALMS-14459))
...
- The profile achievements screen now mentions "Beta" instead of "Preview" when on a Beta build ([MCPE-186514](https://bugs.mojang.com/browse/MCPE-186514))
...
- The Tick Speed can now be set to 0 inside Game Settings Tab. ([MCPE-238556](https://bugs.mojang.com/browse/MCPE-238556))
