...
hash:
  h_01KQWM4NEXAWZYQM42SB002NET: how-to-disable-or-re-enable-realm-events-in-minecraft
  h_01KQWM4NFA03ZNND7HQB9CWMXH: how-to-close-and-open-your-minecraft-realm
---
...
4.  Select the **Realms Hub**.
5.  Select the **Settings **tab and select **Hub**.
6.  Locate the **Realm Events** toggle and select to toggle on or off. 
...
1.  Go to **Server **in the Realms Hub Settings tab.
2.  Select **Temporarily Close Realm**.
3.  After the Realm closes, select **Open Realm**.
