...
hash:
  h_01KQWMCGFVZ0PSB3HNQBETNDBR: how-to-share-an-existing-screenshot-to-realms-stories-while-in-a-realm
  h_01KQWMCGGD55H0B9KTEZGF5F9R: how-to-share-a-screenshot-to-realms-stories-when-not-in-a-realm
---
...
2.  Select **Realms** **Hub**.
3.  From the **Community **tab, access the **Story Feed**. 
4.  Select** Add** **Story**.
5.  Select **Add** **screenshot**.
6.  Select a screenshot to share from your screenshot library.
7.  Write an optional description for your screenshot and select **Post**.

## How to share a screenshot to Realms Stories when not in a Realm

1.  Open Minecraft and select **Play**. 
2.  Select the **Realms** tab.
3.  Select the **Realms Hub **for the Realm where you want to share a screenshot.
4.  In the **Community **tab, select **Add** **Story**.
5.  Select **Add** **screenshot**.
6.  Select the screenshot to share from your screenshot library.
7.  Write an optional description for your screenshot and select **Post**.
