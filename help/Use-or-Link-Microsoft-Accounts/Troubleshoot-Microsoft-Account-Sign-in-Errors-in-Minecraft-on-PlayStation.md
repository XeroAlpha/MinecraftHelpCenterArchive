...
hash:
  h_01K89G7CAMG1NZRDTTPP9VDTFR: oops-this-account-is-already-connected-please-sign-in-with-your-previously-connected-microsoft-account-gamertag
  h_01K89G7CAMVW5DV04KS1E3K7S4: oops-the-microsoft-account-you-are-trying-to-use-is-already-connected-to-another-account-for-playstation-network
  h_01K89G7CANK0D07KWTZ1MAT792: additional-microsoft-and-playstation-account-resources
---

If you [Link Your Microsoft Account to Your PlayStation Network Account in Minecraft: Bedrock Edition](./Link-Your-Microsoft-Account-to-Your-PlayStation-Network-Account-in-Minecraft-Bedrock-Edition.md) and then receive an error message when signing in, there are two common causes:

- You signed out of your Microsoft account but did not unlink it from your PlayStation Network account.
- The Microsoft account you entered is linked to a different PlayStation Network account.

Here are troubleshooting steps for the two error messages.

## Oops! This account is already connected. Please sign in with your previously connected Microsoft account GAMERTAG.

**Issue**: Your PlayStation Network account is linked to a Microsoft account that is different from the Microsoft account you entered when signing in to Minecraft.
...
## Oops! The Microsoft account you are trying to use is already connected to another account for PlayStation Network.

**Issue**: Your Microsoft account is already linked to a different PlayStation Network account.
...
- [Find your Microsoft account email address](https://support.xbox.com/en-US/help/account-profile/manage-account/forgot-microsoft-account-solution)
- [How to recover your account for PlayStation Network (US)](https://www.playstation.com/en-us/support/account/recover-account-psn/)
- [How to sign in and out of PSN](https://www.playstation.com/en-us/support/account/sign-in-psn/)
