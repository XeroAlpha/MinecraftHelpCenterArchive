...
If you encounter an error when you update or open Minecraft: Java Edition, you may be able to fix the issue if you uninstall the game and manually remove all files.
...
If you still need to delete saved worlds, screenshots, and other files, follow these steps:

1.  Select the **Windows Key+R**.
2.  Enter **`C:\Users\%username%\AppData\Roaming`**
3.  Select **OK**.
4.  Delete the **.minecraft** folder.

## Manually uninstall Java Edition on macOS

To uninstall Minecraft, follow Apple’s instructions to [Delete or uninstall apps on Mac](https://support.apple.com/en-us/102610); Minecraft is located in the **Applications** folder.

If you still need to delete saved worlds, screenshots, and other files, follow these steps:

1.  Open a Finder window.
2.  Select Shift+Command+G to open the Go to Folder dialog.
3.  Enter **`~/Library/Application Support/`**
4.  Delete the Minecraft folder.

## Manually uninstall Java Edition on Linux

1.  Open a terminal.
2.  Enter **`rm -vr ~/.minecraft/*`**
