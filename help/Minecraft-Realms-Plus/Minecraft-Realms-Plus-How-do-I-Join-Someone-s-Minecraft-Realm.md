...
- [**Minecraft Realms Overview**](#minecraft-realms-overview)
- [**Create a Realm**](#createarealm)
- [**Invite People to my Realm**](#invitepeopletomyrealm)
- [**Joining Someone’s Realm**](#joining-someones-realm)
- [**Error When Trying to Play Multiplayer with a Child Account **](#errorwhentryingtoplay-multiplayerwithachildaccount)
- **[Realm’s Settings](#realms-settings)**
- [**Troubleshooting**](#troubleshooting)

## Minecraft Realms Overview 

The first 30 days are free if you choose the [ten-player tier](#chooseanameandasize). After this initial free period, you will automatically be charged and continue to be charged every 30 days until you cancel the subscription. 
...
3.  After you log in, [**create**](#createarealm) or **[join](#joining-someones-realm)** a Realm. 
...
[View your subscription from the settings menu](#subscription) in-game to find out which app store processed your purchase. You can also manage your subscription here. If that does not work, you can access your settings in the app store where you made the purchase and cancel the recurring payment. 
...
- [Find the Realms menu](#find-the-realms-menu)
- [Choose a name and a size](#chooseanameandasize)
...
If you have additional questions, see: [Minecraft Realms Plus Multiplayer Troubleshooting](../Realms-Troubleshooting-and-Billing/Minecraft-Realms-Plus-Troubleshooting.md). 
...
![Set](https://minecrafthelp.zendesk.com/hc/article_attachments/16722262291213)

![Privacy](https://minecrafthelp.zendesk.com/hc/article_attachments/16722256023437)
