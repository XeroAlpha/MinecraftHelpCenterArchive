...
link: https://help.minecraft.net/hc/en-us/articles/4412261881229-Minecraft-Launcher-for-Windows-
---
...
- [What is the Minecraft Launcher for Windows?](#what-is-the-minecraft-launcher-for-windows)

- [Do I need the Minecraft Launcher for Windows to play Minecraft: Bedrock Edition, Minecraft: Java Edition, Minecraft Dungeons, or Minecraft Legends?](#do-i-need-the-minecraft-launcher-for-windows-to-play-minecraft-bedrock-edition-minecraft-java-edition-minecraft-dungeons-or-minecraft-legends)

- [Where do I get the Minecraft Launcher for Windows?  ](#where-do-i-get-the-minecraft-launcher-for-windows)

- [Where do I install the Launcher?](#where-do-i-install-the-launcher)

- [If I already own one or more of the games on the Microsoft Store, can I use the new Launcher? ](#if-i-alreadyownoneor-moreof-the-gameson-the-microsoft-store-can-i-use-the-new-launcher)

- [Is the Minecraft Launcher for Windows free? ](#is-the-minecraft-launcher-for-windows-free)

- [Does the Minecraft Launcher for Windows automatically give me access to all games? ](#does-the-minecraft-launcher-for-windows-automatically-give-me-access-to-all-games)

- [What platforms will the Minecraft Launcher for Windows run on?  ](#what-platforms-will-the-minecraft-launcher-for-windows-run-on)

- [What's the difference between the Minecraft Unified Launcher and the Minecraft Launcher for Windows? ](#whats-the-difference-between-the-minecraft-unified-launcher-and-the-minecraft-launcher-for-windows)

- [How is Minecraft Dungeons different being on the Minecraft Launcher for Windows? ](#how-is-minecraft-dungeons-different-being-on-the-minecraft-launcher-for-windows)

- [Will Minecraft Education be available in the Minecraft Launcher for Windows? ](#will-minecraft-education-be-available-in-the-minecraft-launcher-for-windows)

- [Will Minecraft Story Mode be available through this launcher? ](#will-minecraft-story-mode-be-available-through-this-launcher)

- [I play Java Edition and received a Minecraft for Windows code several months/years ago. How is this different from that? ](#i-play-javaeditionandreceivedaminecraft-for-windowscodeseveral-monthsyears-ago-how-is-this-different-from-that)

- [Do I need to uninstall the old launcher? ](#do-i-need-to-uninstall-the-oldlauncher)

## Account Questions

- [Do I need a Microsoft account to use the Minecraft Launcher for Windows? ](#do-i-need-a-microsoft-account-to-use-the-minecraft-launcher-for-windows)
- [How do I sign into my account(s)? ](#how-doisign-into-my-accounts)
- [I have a question about the Microsoft account migration. ](#i-have-a-question-about-the-microsoft-account-migration)
- [How do I switch between my Microsoft accounts to play my games? ](#how-doiswitch-between-mymicrosoft-accountsto-play-my-games)
...
- [How do I update the Minecraft Launcher for Windows? ](#how-do-i-update-the-minecraft-launcher-for-windows)
- [How do I make sure I have the Minecraft Launcher for Windows and not the old Unified Launcher? ](#how-do-i-make-sure-i-have-the-minecraft-launcher-for-windows-and-not-the-old-unified-launcher)
- [Are there beta versions of the Minecraft Launcher for Windows I can get access to? ](#are-there-beta-versions-of-the-minecraft-launcher-for-windows-i-can-get-access-to)
- [Will my Minecraft: Java Edition profiles/installations transfer to the new Launcher?](#will-my-minecraft-java-edition-profilesinstallations-transfer-to-the-new-launcher)
- [How can I make a Desktop shortcut for the Minecraft Launcher for Windows?](#how-can-i-make-a-desktop-shortcut-for-the-minecraft-launcher-for-windows)
- [What happens to my current save files for Minecraft Dungeons?](#what-happens-to-my-current-save-files-for-minecraft-dungeons)
- [I'm having a problem with the Minecraft Launcher for Windows. Can you help?](#im-having-a-problem-with-the-minecraft-launcher-for-windows-can-you-help)
- [Where do I report bugs I find in the Minecraft Launcher?](#where-do-i-report-bugs-i-find-in-the-minecraft-launcher)
- [Is the Beta version of the game available in the launcher?](#is-the-beta-version-of-the-game-available-in-the-launcher)
- [Does this mean players on Java and Bedrock can cross-play?](#does-this-mean-players-on-java-and-bedrock-can-cross-play)
- [Will my mods carry over to the new launcher?](#will-my-mods-carry-over-to-the-new-launcher)
...
The Minecraft Unified Launcher only launches Java Edition and Minecraft Dungeons and was made for Windows 7/8. The Minecraft Launcher for Windows will launch those titles and Minecraft: Bedrock Edition, and it works on both Windows 10 and Windows 11. 
...
We have answers available on our [Minecraft: Java Edition Account Migration FAQ](https://help.minecraft.net/hc/en-us/articles/360050865492-Minecraft-Java-Edition-Account-Migration-FAQ). 
...
![blobid0.png](https://minecrafthelp.zendesk.com/hc/article_attachments/4412261824525)

Previous Minecraft Unified Launcher (Win32): 

![blobid1.png](https://minecrafthelp.zendesk.com/hc/article_attachments/4412261837069)
...
1.  Open the %appdata%/.minecraft folder
