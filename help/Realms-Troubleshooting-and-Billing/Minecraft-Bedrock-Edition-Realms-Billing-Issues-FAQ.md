...
link: https://minecrafthelp.zendesk.com/hc/en-us/articles/4410001194765-Minecraft-Bedrock-Edition-Realms-Billing-Issues-FAQ
---
...
-   **[Why are there two versions of Realms servers?](https://minecrafthelp.zendesk.com/hc/en-us/articles/4410001194765-Minecraft-Bedrock-Edition-Realms-Billing-Issues-FAQ#h_01FGCVBYDM8GN2ZX1D4Z72KKZ2)**
-   **[Are there trials available for Minecraft Realms Plus?](https://minecrafthelp.zendesk.com/hc/en-us/articles/4410001194765-Minecraft-Bedrock-Edition-Realms-Billing-Issues-FAQ#h_01FGCVCP6CCHK01ZZR1BMWCDY0)**
-   **[How do I renew my Expired Realm?](https://minecrafthelp.zendesk.com/hc/en-us/articles/4410001194765-Minecraft-Bedrock-Edition-Realms-Billing-Issues-FAQ#h_01FGCVDXG37NNQ1JK7S3EHJF7A)**
-   **[\'Couldn\'t Create Realm Right Now\' Error](https://minecrafthelp.zendesk.com/hc/en-us/articles/4410001194765-Minecraft-Bedrock-Edition-Realms-Billing-Issues-FAQ#h_01H7BA3F80YHKBJG6M6XGN5YRP)**
-   **[How does Mojang backup your Realm?](https://minecrafthelp.zendesk.com/hc/en-us/articles/4410001194765-Minecraft-Bedrock-Edition-Realms-Billing-Issues-FAQ#h_01H0JYT6EDNX7N0Y86V1J10YWS)**
-   **[How do I cancel my Realms Subscription?](https://minecrafthelp.zendesk.com/hc/en-us/articles/4410001194765-Minecraft-Bedrock-Edition-Realms-Billing-Issues-FAQ#h_01FGCVE88JFXE24WPYJJHZGQ9W)**
-   **[Managing Subscriptions:](https://minecrafthelp.zendesk.com/hc/en-us/articles/4410001194765-Minecraft-Bedrock-Edition-Realms-Billing-Issues-FAQ#h_01G7FQZG9Y7ARPF4KWG1DNJGN7)**
    -   **[Android / Google Play](https://minecrafthelp.zendesk.com/hc/en-us/articles/4410001194765-Minecraft-Bedrock-Edition-Realms-Billing-Issues-FAQ#Android%20/%20Google%20Play)**
    -   **[Amazon](https://minecrafthelp.zendesk.com/hc/en-us/articles/4410001194765-Minecraft-Bedrock-Edition-Realms-Billing-Issues-FAQ#Amazon)**
    -   **[iOS](https://minecrafthelp.zendesk.com/hc/en-us/articles/4410001194765-Minecraft-Bedrock-Edition-Realms-Billing-Issues-FAQ#iOS)**
    -   **[Nintendo Switch](https://minecrafthelp.zendesk.com/hc/en-us/articles/4410001194765-Minecraft-Bedrock-Edition-Realms-Billing-Issues-FAQ#Nintendo%20Switch)**
    -   **[PlayStation](https://minecrafthelp.zendesk.com/hc/en-us/articles/4410001194765-Minecraft-Bedrock-Edition-Realms-Billing-Issues-FAQ#Playstation)**
    -   **[Windows 10 and above](https://minecrafthelp.zendesk.com/hc/en-us/articles/4410001194765-Minecraft-Bedrock-Edition-Realms-Billing-Issues-FAQ#Windows%2010%20and%20above)**
...
In Minecraft: Bedrock Edition** **for Windows, Xbox, PlayStation®, Chromebook, Nintendo Switch, or mobile devices:

1.  Select **Edit Realm** in the **Realms**
2.  Select the option to **Download World**. 

**Note: Make sure there is enough room to store it on your device! **

![mceclip0.png](https://minecrafthelp.zendesk.com/hc/article_attachments/4410001356813)
...
1.  Select **Replace World**
2.  Choose the backup you've created of your previous Realm. 

Your new Realm should now contain your previous world. 

![mceclip1.png](https://minecrafthelp.zendesk.com/hc/article_attachments/4410001399053)
...
If you\'ve paid your Realm subscription but your Realm is listed as \'expired,\' please contact [Minecraft Support](https://help.minecraft.net/hc/en-us/requests/new).

## \'Couldn\'t Create Realm Right Now\' Error

If you\'re encountering a \'Couldn\'t Create Realm Right Now\' error, please try restarting Minecraft seeing if a Realm appears in your Realms section. If that doesn\'t work, please try the following steps:

1.  Log into the [Microsoft account](https://account.microsoft.com/account) in which you attempted to make a Realms subscription.
2.  Navigate to the \'Services & Subscriptions\' tab on the top.
3.  Ensure a Minecraft Realms subscription is active.
    1.  If a Realms subscription is active and you still cannot create a Realm, please contact [Minecraft Support](https://aka.ms/Minecraft-Support).
    2.  If a Realms subscription is not active, please try going through the Realms purchase flow again.
...
1.  Go to **Settings** from the game\'s main menu. \
    ![mceclip2.png](https://minecrafthelp.zendesk.com/hc/article_attachments/4410001437837) 
2.  Select the **Subscriptions** option in the list on the left. \
    ![mceclip3.png](https://minecrafthelp.zendesk.com/hc/article_attachments/4409995458829) 
3.  Click the **Manage** button on the subscription you want to manage in the Settings menu.

This takes you to the platform store where you can review and cancel your subscription as needed. 

![mceclip4.png](https://minecrafthelp.zendesk.com/hc/article_attachments/4409995493261) 

## Here's how to manage your subscription on each platform:
...
See the [Cancel, pause, or change a subscription on Google Play](https://support.google.com/googleplay/answer/7018481?co=GENIE.Platform%3DDesktop&hl=en&oco=0) help page for more information. 
...
See the [How to cancel a subscription from Apple](https://support.apple.com/en-us/HT202039) help page for more information.

### Nintendo Switch 

Starting December 13th, 2021, we will be offering recurring Realms and Realms Plus subscriptions on Nintendo Switch instead of one-time purchases. Here's what this means for Realms players: 

-   This subscription will be an ongoing monthly service. Once you sign up, your Realms will be renewed automatically every month until you cancel. 
-   You will be able to use a credit card to pay for this service instead of having to pay in Minecoins. Minecoins can no longer be used to purchase Minecraft Realms. 
-   As always, only the Realms owner must pay, friends always join for free  

To set up this process, just follow the steps below. If you already have an active Realms subscription, it can be renewed as a recurring subscription once it runs out.   

1.  Launch the game 
2.  Select Settings 
3.  Go to the Subscriptions tab 
4.  Find your Expired Realm 
5.  Click on "Renew", and you will be prompted to the "Renew Your Realm" menu 
6.  Agree to the Terms and Conditions, then click \"Renew for \$3.99 (2-player Realm) or \$7.99 (Realms Plus) per month\". You will be redirected to the \"Automatic Renewal Subscription\" page of the Nintendo eShop 
7.  Click on the "Proceed to purchase" button. 
8.  Enter your address to register your location to Nintendo. 
9.  Select a payment method (credit card or available Nintendo eShop funds).  
10. Enter your username and password to authenticate your identity. 
11. Review your selections. If everything looks good, click "Add Funds and Purchase".  
12. Click "Return to Software" to go back to Minecraft: Bedrock Edition. You will see a "Creating Realm" dialogue. 
13. You can now join your Realm with a recurring subscription.  

Please note that at Realms subscriptions for Nintendo Switch are not available in South Korea at this time.

If you have any questions regarding this process, please contact [Minecraft Support](https://aka.ms/Minecraft-Support). If for any reason you need a refund for a purchase made on the Nintendo eShop, please contact [Nintendo Customer Support](https://en-americas-support.nintendo.com/).  \
...
If you would like to keep your subscription, you can select **Turn On Auto-Renew** before the renewal date of the current subscription to keep it active. To manage subscriptions via console, please check out [PlayStation\'s guide](https://www.playstation.com/en-us/support/store/cancel-ps-store-subscription/) for specific instructions.

### Windows 10 and above

1.  Go to the [Microsoft Account](https://account.microsoft.com/services/) page and log in to your account. 
