...
hash:
  h_01KQWMA6G44JW2KEQ0WK2YD0PE: how-to-set-yourminecraft-bedrock-edition-realm-server-region-preference
---
...
3.  Select the **Realms Hub** for your Realm. 
4.  Select the **Settings **tab.
5.  Select **Server**.
6.  Select the dropdown menu under S**erver region preference**.

If you do not set a preference, the Realm server location is automatically chosen based on the realm owner’s connection by default. The following options are available:
...
-  
- **Specific Region**: The server will be hosted in the selected location you choose.
