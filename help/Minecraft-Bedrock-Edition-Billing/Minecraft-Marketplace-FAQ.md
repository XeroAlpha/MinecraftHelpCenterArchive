...
- [Which devices is Minecraft Marketplace available on?](#which-devices-is-minecraft-marketplace-available-on)
  - [Supported Systems and Devices](#supported-systems-and-devices)
- [Do I need an Xbox Live account to make purchases in Marketplace?](#do-i-need-an-xbox-live-account-to-make-purchases-in-marketplace)
- [How do I know what account to use for Minecraft?](#how-do-i-know-what-account-to-use-for-minecraft)
...
- [What can I spend Minecoins on?](#what-can-i-spend-minecoins-on)
  - [Can I save things to purchase later on a Wishlist?](#can-i-save-things-to-purchase-later-on-a-wishlist)
...
- [I purchased the wrong Minecraft world by mistake. Can I get a refund?](#i-purchased-the-wrong-minecraft-world-by-mistake-can-i-get-a-refund)
...
- [I have missing Marketplace items; where can I find them?](#i-have-missing-marketplace-items-where-can-i-find-them)
...
- [How do I become a Minecraft partner and create content for the Marketplace?](#how-do-i-become-a-minecraft-partner-and-create-content-for-the-marketplace)
...
**Note: Minecraft Marketplace is not currently supported on Xbox 360, Windows Phone 8, PlayStation<sup>TM</sup> Editions (Legacy version), Wii U, and Apple TV’.**
