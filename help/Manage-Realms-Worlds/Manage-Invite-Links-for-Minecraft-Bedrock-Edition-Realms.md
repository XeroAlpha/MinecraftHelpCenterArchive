...
hash:
  h_01KQWKTJFSQGH63ZT3Y1AMPPFT: create-a-minecraft-bedrock-edition-invite-link
  h_01KQWKTJGNT78HS80CS09E57T6: manage-minecraft-bedrock-edition-realm-links
...
3.  Select your Realm and then select **Realm Hub** on the Realm screen.
4.  Select the **Community **tab.
5.  Select **Members**.
6.  Select **Manage Realm Members**.
7.  Select **Invite Links**.
8.  Select **Add new invite link**.
9.  Adjust settings, then copy and share the link. 
