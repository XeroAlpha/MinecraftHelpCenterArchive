...
- To report a crash, attach the crash report to the bug report. You can find crash reports in the “crash-reports” subfolder of the [.minecraft](../Minecraft-Java-Edition-Technical/Managing-Data-and-Game-Storage-in-Minecraft-Java-Edition.md) data folder. If there is no related crash report, attach the launcher log.
