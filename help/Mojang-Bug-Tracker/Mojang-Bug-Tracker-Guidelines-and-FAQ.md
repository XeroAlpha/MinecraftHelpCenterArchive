...
link: https://minecrafthelp.zendesk.com/hc/en-us/articles/4408887473421-Mojang-Bug-Tracker-Guidelines-and-FAQ
---
...
-   [What Can Be Reported on the Bug Tracker and What Cannot?](https://minecrafthelp.zendesk.com/hc/en-us/articles/4408887473421-Mojang-Bug-Tracker-Guidelines-and-FAQ#h_01FF6AZA7WB59P77QC8PH0V2NK)
-   [How to Use the Bug Tracker's Search Efficiently](https://minecrafthelp.zendesk.com/hc/en-us/articles/4408887473421-Mojang-Bug-Tracker-Guidelines-and-FAQ#h_01FF67F3750SYT9SPDT1HDMPYC)
-   [Resolution Statuses](https://minecrafthelp.zendesk.com/hc/en-us/articles/4408887473421-Mojang-Bug-Tracker-Guidelines-and-FAQ#h_01GHE6AGRHQM3WJVCMNQVA6S34)
-   [Contributing Guidelines](https://minecrafthelp.zendesk.com/hc/en-us/articles/4408887473421-Mojang-Bug-Tracker-Guidelines-and-FAQ#h_01FF6B0GPYQJR44QAMJN7YEXXR)
-   [General Bug Report Guidelines](https://minecrafthelp.zendesk.com/hc/en-us/articles/4408887473421-Mojang-Bug-Tracker-Guidelines-and-FAQ#h_01FF66ASEAVED34B6NDVWZMCYE)
-   [Project-specific Guidelines](https://minecrafthelp.zendesk.com/hc/en-us/articles/4408887473421-Mojang-Bug-Tracker-Guidelines-and-FAQ#h_01FF6B1MMT7GDCQ1YWZFGABB03)
-   [Example Template](https://minecrafthelp.zendesk.com/hc/en-us/articles/4408887473421-Mojang-Bug-Tracker-Guidelines-and-FAQ#h_01FF6B26Q7A5BTZT7RGCBX9WC4)
-   [Where can I view or submit bugs?](https://minecrafthelp.zendesk.com/hc/en-us/articles/4408887473421-Mojang-Bug-Tracker-Guidelines-and-FAQ#h_01FF6B673YQG4259E0V0NF353X)
-   [FAQs](https://minecrafthelp.zendesk.com/hc/en-us/articles/4408887473421-Mojang-Bug-Tracker-Guidelines-and-FAQ#h_01FF668Y1JTCW25FJHWBBQ6T7M)
-   [Why can't I log in to the Mojang bug tracker?](https://minecrafthelp.zendesk.com/hc/en-us/articles/4408887473421-Mojang-Bug-Tracker-Guidelines-and-FAQ#h_01FF6B6ZHQ3J58994836RP5KNQ)
-   [I have more questions, where can I ask them?](https://minecrafthelp.zendesk.com/hc/en-us/articles/4408887473421-Mojang-Bug-Tracker-Guidelines-and-FAQ#h_01FF65PCEV48PB58C9GPDGFZXJ)
...
If you need additional help with reporting a bug or have questions about the bug tracker, feel free to ask other players in the community by visiting our official Minecraft social channels, or visit one of the [community links](https://minecrafthelp.zendesk.com/hc/en-us/articles/4408887473421-Mojang-Bug-Tracker-Guidelines-and-FAQ#h_01FF65PCEV48PB58C9GPDGFZXJ).
...
-   **Suggestions and feature requests**
    -   To suggest a new feature for Minecraft, or to post a suggestion, do so on the official [Minecraft feedback site](https://feedback.minecraft.net/) or visit one of the [community links](https://minecrafthelp.zendesk.com/hc/en-us/articles/4408887473421-Mojang-Bug-Tracker-Guidelines-and-FAQ#h_01FF65PCEV48PB58C9GPDGFZXJ).
-   **Parity issues introduced prior to the Buzzy Bees update**
    -   To report a parity issue (a difference between the different editions of the game), review the official [parity issue guidelines](https://feedback.minecraft.net/hc/en-us/articles/360015877192-Parity-Requests-and-You-A-Guide) before doing so. If your report does not fulfill all of the criteria, it belongs on the official [Minecraft feedback site](https://feedback.minecraft.net/).
...
-   **General connection issues (Realms, Marketplace) and authentication issues**
    -   These issues are typically outside the control of the game's code and are usually due to server maintenance, downtime, or local network configuration. If the issues persist, consider asking the community (see [FAQs](https://minecrafthelp.zendesk.com/hc/en-us/articles/4408887473421-Mojang-Bug-Tracker-Guidelines-and-FAQ#h_01FF668Y1JTCW25FJHWBBQ6T7M)).
...
-   Restrict your search to the project you want to report the bug to. A list of all current projects with their description is included in the [General Bug Guidelines](https://minecrafthelp.zendesk.com/hc/en-us/articles/4408887473421-Mojang-Bug-Tracker-Guidelines-and-FAQ#h_01FF66ASEAVED34B6NDVWZMCYE) section.
...
If you find that your issue has already been reported, look at the [Resolution](https://minecrafthelp.zendesk.com/hc/en-us/articles/4408887473421-Mojang-Bug-Tracker-Guidelines-and-FAQ#h_01FFNM44167TBFS73NJ9TZ06M3) of the report to determine what steps to take next.
...
-   If you want to initiate a discussion about a bug or need to report someone, take the discussion outside of the bug tracker (see [FAQs](https://minecrafthelp.zendesk.com/hc/en-us/articles/4408887473421-Mojang-Bug-Tracker-Guidelines-and-FAQ#h_01FF668Y1JTCW25FJHWBBQ6T7M)), do not comment directly on the bug tracker.
...
-   The "Labels" field is for use by helpers or moderators to help organize bug reports. Only use existing labels and don't create new labels. For more information on how labels work, see our [FAQ](https://help.minecraft.net/hc/en-us/articles/4408887473421-Mojang-Bug-Tracker-Guidelines-and-FAQ#h_01FF668Y1JTCW25FJHWBBQ6T7M).
...
-   To report a crash, attach the crash report to the bug report. You can find crash reports in the "crash-reports" subfolder of the [.minecraft](https://help.minecraft.net/hc/en-us/articles/4409159214605-Managing-Data-and-Game-Storage-in-Minecraft-Java-Edition-) data folder. If there is no related crash report, attach the launcher log.
...
To submit a bug, or view the status of an issue, visit one of the bug tracking resources listed below. If submitting, use the [search feature](https://minecrafthelp.zendesk.com/hc/en-us/articles/4408887473421-Mojang-Bug-Tracker-Guidelines-and-FAQ#h_01FF67F3750SYT9SPDT1HDMPYC) first to ensure that someone else has not already submitted the same issue.\
...
You can leave a comment on the resolved bug report. For extra visibility, you can also ask other players and moderators. (See [Community Links](https://minecrafthelp.zendesk.com/hc/en-us/articles/4408887473421-Mojang-Bug-Tracker-Guidelines-and-FAQ#h_01FF65PCEV48PB58C9GPDGFZXJ).)
...
However, if you want to discuss an issue, for instance, whether you think it should count as a valid bug, or whether it should be fixed or not, take the discussion outside of the bug tracker. (See [Community Links](https://minecrafthelp.zendesk.com/hc/en-us/articles/4408887473421-Mojang-Bug-Tracker-Guidelines-and-FAQ#h_01FF65PCEV48PB58C9GPDGFZXJ).)
...
You can also get in touch with other players who frequent the bug tracker through our [Community Links](https://minecrafthelp.zendesk.com/hc/en-us/articles/4408887473421-Mojang-Bug-Tracker-Guidelines-and-FAQ#h_01FF65PCEV48PB58C9GPDGFZXJ), where you can communicate with others who want to help.
...
Helpers can edit any bug report as if it was their own, in order to add additional information about the bug or to clarify wording or an unclear description. They can also update the [Confirmation Status](https://minecrafthelp.zendesk.com/hc/en-us/articles/4408887473421-Mojang-Bug-Tracker-Guidelines-and-FAQ#h_01FF68NT3PW1FPTD8ZP61H9H5A).\
