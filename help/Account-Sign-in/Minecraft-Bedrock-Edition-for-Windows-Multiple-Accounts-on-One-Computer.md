...
1.  Select the **Start button** in Windows, click **Settings (cogwheel)**, go to **Accounts**, and then click **Other Users**.
2.  Select **Add someone else to this PC** and fill in their information. You can choose to create a user with a Microsoft account or make a local user without an account. Do not use an exclamation mark in your user name or Minecraft: Bedrock Edition will not run.
