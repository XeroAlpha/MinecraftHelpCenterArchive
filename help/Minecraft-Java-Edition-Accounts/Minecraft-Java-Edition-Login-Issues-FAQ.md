...
- **[Minecraft: Java Edition Account Types](#minecraft-java-edition-account-types)**
- **[Do I Login With my Email Address or my Username?](#do-i-login-with-my-email-address-or-my-java-profile-name)**
- **[I Forgot my Password](#iforgot-my-password)**
- **[I Forgot the Email Address Used for my Account](#iforgot-the-email-address-used-for-my-account)**
- **[I Need to Change the Email Address Used for my Account](#ineedtochangetheemailaddressusedformyaccount)**
- **[I Remember my Email Address, But Not my Username](#i-remember-my-email-address-but-not-my-java-profile-name)**
- **[I'm Getting an Error That Says “Login failed: Invalid username or password"](#im-getting-an-error-that-says-login-failed-invalid-java-profile-name-or-password)**
- **[I'm Having Trouble with my Security Questions](#im-havingtrouble-with-my-security-questions)**
- **[I Need to Change or Recover my Registered Email Address](#i-need-to-change-or-recover-my-registered-email-address)**
- **[I’m not receiving emails from Mojang Studios](#im-notreceivingemailsfrommojang-studios)**
- **[I Can't Log In to My Mojang Account](#i-cant-logintomy-mojang-account)**
- **[I Can Only Play the Demo](#i-can-only-play-the-demo)**
- **[I Changed Computers, my Account is Gone](#i-changed-computers-myaccount-is-gone)**

## Minecraft: Java Edition Account Types  
...
- You may need to change your password to something you haven't previously used. If you need to reset your password, see: [I Forgot my Password](#iforgot-my-password). 
...
Make sure you are logging in with your correct Java profile name and password. If you have forgotten your password, see: [I Forgot my Password](#iforgot-my-password) above to reset it by entering your email.   
...
![blobid0.png](https://minecrafthelp.zendesk.com/hc/article_attachments/4409162286861)
...
If you cannot log in, make sure that you are typing your email or Java profile name exactly as you had it before. Note any underscores, letters replaced by numbers, or characters that look like other characters. If you are having trouble with your password, see: [I Forgot My Password](#iforgot-my-password) information in this article according to your account type.
